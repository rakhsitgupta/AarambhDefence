...
import AarambhLogo from '../../assets/Logo/Logo-Full-Light.png'
    ...
    return (
        <nav className={`z-[10] flex h-14 w-full items-center justify-center border-b-[1px] border-b-richblack-700 text-white translate-y-0 transition-all ${showNavbar}`}>
            <div className='flex w-11/12 max-w-maxContent items-center justify-between'>
                {/* Logo */}
                <Link to="/">
                    <img src={AarambhLogo} width={160} height={42} loading='lazy' />
                </Link>
                            ...
                            <li key={index}>
                                {
                                    link.title === "Catalog" ? (
                                        ...
                                        <div
                                            className={`group relative flex items-center h-full cursor-pointer gap-1 px-3 py-1 rounded-xl ${matchRoute('/about') ? 'bg-yellow-25 text-black' : 'text-richblack-25'}`}
                                        >
                                            <p>{link.title}</p>
                                            <MdKeyboardArrowDown className="transition-all duration-200 group-hover:rotate-180" />
                                            <div className="invisible absolute left-[50%] top-[100%] z-[1000] flex w-[200px] translate-x-[-50%] translate-y-[3em] 
